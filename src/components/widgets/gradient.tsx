...
export const Gradient = component$((props: QwikIntrinsicElements['div']) => {
  return (
    <div
      {...props}
      class={`${props.className ?? ''} absolute inset-2 bottom-0 h-[90vh]  ring-1 ring-inset ring-black/5 bg-[linear-gradient(115deg,var(--tw-gradient-stops))] from-[#fff1be] from-[28%] via-[#ee87cb] via-[70%] to-[#b060ff] sm:bg-[linear-gradient(145deg,var(--tw-gradient-stops))]`}
