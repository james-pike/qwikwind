...
export default component$(() => {
  ...
  return (
    <header
      id="header"
      class={`sticky top-0 z-40 flex-none mx-auto w-full border-b-0 border-b-black border-gray-50/0 transition-[opacity] ease-in-out ${
        store.isScrolling
          ...
          <div class="items-center flex justify-between w-full md:w-auto">
            ...
            <span class="ml-4 rtl:ml-0 rtl:mr-4">
              <a
                ...
                class="btn btn-primary ml-2 py-2.5 px-5.5 md:px-6 font-semibold bg-primary shadow-none text-sm w-auto"
              >
                Contact Us
              </a>
            </span>
